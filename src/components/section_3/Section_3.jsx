  ...
  <div class="container mx-auto px-6 lg:flex lg:items-center lg:space-x-10">
    ...
    <div class="lg:w-1/2 text-center lg:text-left ml-14">
      ...
      <p class="text-[0.8rem] text-gray-700 mt-4">
        Optimize your exam preparation with Topical <br /> Custom Papers for
        personalized and effective <br /> learning.
      </p>
      <button
        class="mt-6 px-6 py-2 bg-green-400 text-white text-sm rounded-full shadow hover:bg-green-500"
      >
        Start Customizing
      </button>
    </div>
